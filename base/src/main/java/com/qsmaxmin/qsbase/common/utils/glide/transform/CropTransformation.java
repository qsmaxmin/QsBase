...
public class CropTransformation extends BitmapTransformation {
    ...
    private static final String CUSTOM_ID = "com.qsmaxmin.qsbase.common.utils.glide.transform.CropTransformation";
    ...
    @Override public int hashCode() {
        return CUSTOM_ID.hashCode() + width * 100000 + height * 1000 + cropType.ordinal() * 10;
    }

    @Override public void updateDiskCacheKey(@NonNull MessageDigest messageDigest) {
        messageDigest.update((CUSTOM_ID + width + height + cropType).getBytes(CHARSET));
    }
}
