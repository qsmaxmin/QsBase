...
public class ColorFilterTransformation extends BitmapTransformation {
    ...
    private static final String CUSTOM_ID = "com.qsmaxmin.qsbase.common.utils.glide.transform.ColorFilterTransformation";
    ...
    @Override public int hashCode() {
        return CUSTOM_ID.hashCode() + color * 10;
    }

    @Override public void updateDiskCacheKey(@NonNull MessageDigest messageDigest) {
        messageDigest.update((CUSTOM_ID + color).getBytes(CHARSET));
    }
